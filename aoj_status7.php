...
<?php
    ...
    print("<th>ID</th><th>名前</th><th>3か月前</th><th>2か月前</th><th>1か月前</th><th>3週間前</th><th>2週間前</th><th>1週間前</th><th>6日前</th><th>5日前</th><th>4日前</th><th>3日前</th><th>2日前</th><th>1日前</th><th>今日</th><th>進捗</th>");
    print("</tr>");
    ...
    for ($i = 0; $i < count($student_id_number); $i++){
        ...
        print("<td>".$student_id_number[$i]."</td><td>".$name."</td><td>".$solved_84."</td>");
        print($str_56.$str_28.$str_21.$str_14.$str_7.$str_6.$str_5.$str_4.$str_3.$str_2.$str_1.$str_0);
